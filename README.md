...
| _Horn of the Abyss_ | _Forged in Fire_ | `FACT07.wav` | `campaign.h4fact.0404.h3m.prolog` | Todd |
| _Horn of the Abyss_ | _Forged in Fire_ | `FACT08.wav` | `campaign.h4fact.0404.h3m.epilog` | Todd |
| _Horn of the Abyss_ | _Forged in Fire_ | `FACT09.wav` | `campaign.h4fact.0405.h3m.prolog` | Todd |
| _Horn of the Abyss_ | _Forged in Fire_ | `FACT10.wav` | `campaign.h4fact.0405.h3m.prolog2` | Todd |
| _Horn of the Abyss_ | _Forged in Fire_ | `FACT11.wav` | `campaign.h4fact.0405.h3m.epilog` | Todd |
| _Horn of the Abyss_ | _Forged in Fire_ | `FACT12.wav` | `campaign.h4fact.0405.h3m.epilog2` | Todd |
...
| _Horn of the Abyss_ | _Forged in Fire_ | `FACT15.wav` | `campaign.h4fact.0407.h3m.prolog` | Todd |
